...
export const PARTS: Part[] = [
  { id: "foundations", title: "Part 1 — Foundations", description: " " },
  { id: "patterns", title: "Part 2 — Prompt Patterns", description: " " },
    { id: "mastery", title: "Part 3 — Learn with Chatgpt", description: " " },
  { id: "advanced", title: "Part 4 — Advanced & Production", description: " " },
];
...
const titles: Array<[string, string, string]> = [
  // Part 1 — AI ও Prompt Engineering-এর ভিত্তি

  [
    "foundations",
    "AI বিপ্লবের সূচনা",
    "Artificial Intelligence কীভাবে আমাদের বিশ্বকে পরিবর্তন করছে তার পরিচিতি।",
  ],
  [
    "foundations",
    "Prompt Engineering কী?",
    "Prompt Engineering-এর মৌলিক ধারণা এবং এর গুরুত্ব।",
  ],
  [
    "foundations",
    "AI কীভাবে চিন্তা করে?",
    "Language Model কীভাবে তথ্য প্রক্রিয়াকরণ ও উত্তর তৈরি করে তা বোঝা।",
  ],
  [
    "foundations",
    "একটি ভালো Prompt-এর গঠন",
    "কার্যকর Prompt লেখার মূল উপাদান ও কাঠামো।",
  ],
  ...
  [
    "patterns",
    "Zero-Shot Prompting",
    "কোনো উদাহরণ ছাড়াই AI-কে নির্দেশনা দেওয়ার পদ্ধতি।",
  ],
  [
    "patterns",
    "One-Shot Prompting",
    "একটি উদাহরণের মাধ্যমে AI-কে কাজ শেখানোর কৌশল।",
  ],
  [
    "patterns",
    "Few-Shot Prompting",
    "একাধিক উদাহরণ ব্যবহার করে আরও ভালো output পাওয়ার পদ্ধতি।",
  ],
  [
    "patterns",
    "Role Prompting",
    "AI-কে নির্দিষ্ট ভূমিকা দিয়ে আরও নির্ভুল উত্তর পাওয়া।",
  ],
  [
    "patterns",
    "Chain of Thought Prompting",
    "ধাপে ধাপে reasoning ব্যবহার করে সমস্যা সমাধানের কৌশল।",
  ],
  [
    "patterns",
    "Self-Consistency Prompting",
    "একাধিক reasoning path ব্যবহার করে সেরা উত্তর নির্বাচন।",
  ],
  [
    "patterns",
    "Tree of Thoughts Prompting",
    "বিভিন্ন চিন্তার শাখা অনুসন্ধান করে সিদ্ধান্ত নেওয়ার পদ্ধতি।",
  ],
  [
    "patterns",
    "Meta Prompting",
    "Prompt তৈরি ও উন্নত করার জন্য Prompt ব্যবহার করা।",
  ],

  // Part 3 — ChatGPT Mastery / Practical Usage

  [
    "mastery",
    "Blog Writing",
    "ChatGPT ব্যবহার করে ব্লগ আর্টিকেল তৈরি করার কৌশল।",
  ],
  [
    "mastery",
    "SEO Content Writing",
    "Google ranking-এর জন্য SEO-friendly content লেখার পদ্ধতি।",
  ],
  [
    "mastery",
    "Email Writing",
    "Professional ও effective email লেখার জন্য ChatGPT ব্যবহার।",
  ],
  [
    "mastery",
    "Book Writing",
    "ChatGPT-এর সাহায্যে বই লেখা, outline তৈরি এবং chapter development।",
  ],

  // Part 4 — Advanced ChatGPT Features

  [
    "advanced",
    "Custom Instructions",
    "ChatGPT-এর behavior ও response style customize করার উপায়।",
  ],
  [
    "advanced",
    "Memory",
    "ChatGPT কীভাবে আপনার preference ও context মনে রাখে।",
  ],
  [
    "advanced",
    "Deep Research",
    "Research mode ব্যবহার করে গভীর বিশ্লেষণ ও তথ্য সংগ্রহ।",
  ],
  [
    "advanced",
    "Projects",
    "একাধিক chat, file এবং context সংগঠিতভাবে পরিচালনা করা।",
  ],
];
